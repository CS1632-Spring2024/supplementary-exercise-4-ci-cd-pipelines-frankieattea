...
public class RentACatUnitTest {
	...
	public void testRentCatNumCats3() {
		...
		try{
			...
			Method m2 = c2.getClass().getDeclaredMethod("getRented");

			m2.setAccessible(true);

			boolean result = (boolean) m2.invoke(c2); 
	...
	public void testRentCatFailureNumCats3() {
		try{
		    ...
		    out.reset(); //only want the second invoke output
	...
	public void testReturnCatNumCats3() {
		...
		try{
			...
			out.reset();  //only want to compare with the returnCat output

			Method m2 = r.getClass().getDeclaredMethod("returnCat", int.class);
			m2.setAccessible(true);

			boolean result = (boolean) m2.invoke(r, 2);
			assertTrue(result); 
	...
	public void testReturnFailureCatNumCats3() {
		...
		try{
			...
			e.printStackTrace();
			fail("Exception occured fucker: " + e.getMessage());
		}
		// TODO: Fill in
	}
